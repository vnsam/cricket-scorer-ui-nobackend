...
import { UpdateCurrentRunScore, runScoreAction } from '../store/runScoreReducer';
...
const RunScorer = props =>
  (
    <div>
      <button
        value="0"
        className={props.selectedState}
        onClick={(event) => { props.runScoreDispatch(event.target.value); props.toggle ;}}
      >
      0
      </button>
      <button

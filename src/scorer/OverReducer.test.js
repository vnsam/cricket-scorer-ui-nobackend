import OverReducer from './OverReducer.js';
import Over from '../model/over';
import { BALL_TYPE_REGULAR, BALL_TYPE_WIDE, ACTION_BALL_PLAYED } from '../store/BallPlayedReducer.js';
describe('over', () => {

  function ball(type, playerRuns, teamRuns, extraBall, out) {
    return {type, playerRuns, teamRuns, extraBall, out};
  };
